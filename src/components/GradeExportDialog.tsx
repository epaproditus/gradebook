...
export const GradeExportDialog: FC<GradeExportDialogProps> = ({ 
  assignments, 
  students, 
  onExport 
}) => {
  ...
  // Handle the button click separately from the dialog trigger
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-md">
          ...
          <Button 
            onClick={() => {
              onExport([selectedAssignment], selectedPeriods, mergePeriods);
              setOpen(false);
            }}
