...
const RosterView: FC<RosterViewProps> = ({
  ...
  const handleCreateAssignment = async () => {
    ...
    try {
      ...
      setAssignmentOrder(prev => [...prev, data.id]);
            ...
            <div className="space-y-4 py-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNewAssignment(prev => prev ? {
                    ...prev,
                    name: e.target.value
                  } : {
                    name: e.target.value,
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Type</Label>
                  <Select
                    value={newAssignment?.type || 'Daily'}
                ...
                <div>
                  <Label>Subject</Label>
                  <Select
                    value={newAssignment?.subject || 'Math 8'}
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {newAssignment?.date ? format(newAssignment.date, 'PPP') : 'Pick a date'}
                    </Button>
                  </PopoverTrigger>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        setNewAssignment(prev => {
                          ...
                          const periods = base.periods.includes(periodId)
                            ? base.periods.filter(p => p !== periodId)
